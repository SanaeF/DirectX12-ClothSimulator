...
//#include<d3dx12.h>
//#include "DirectXLib/Source/Graphics/Graph3D/FbxModel/FbxModel.h"
//
//
//#ifdef _DEBUG
//#include<iostream>
...
//	char signature[3];
//	PMDHeader pmdheader = {};
//	auto fp = fopen("Model/チルノ/えと式 チルノver1.02.pmd", "rb");
...
//	//OKだと思います。
//	auto heapUploadi = CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_UPLOAD);
//	auto resDesci = CD3DX12_RESOURCE_DESC::Buffer(indices.size() * sizeof(indices[0]));
//	result = _dev->CreateCommittedResource(
//		&heapUploadi,
//		D3D12_HEAP_FLAG_NONE,
//		&resDesci,
...
//	result = D3DCompileFromFile(L"Vertex3D.hlsl",
...
//		exit(1);//行儀悪いかな…
//	}
//	result = D3DCompileFromFile(L"Pixel3D.hlsl",
//		nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE,
//		"Pixel3D", "ps_5_0",
//		D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION,
//		0, &_psBlob, &errorBlob);
...
//	auto heapUploadm = CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_UPLOAD);
//	auto resDescm = CD3DX12_RESOURCE_DESC::Buffer((sizeof(MatricesData) + 0xff) & ~0xff);
//	result = _dev->CreateCommittedResource(
//		&heapUploadm,
//		D3D12_HEAP_FLAG_NONE,
//		&resDescm,
...
//		vbView = fbxData.getVertexBufferView();
//		ibView = fbxData.getIndexBufferView();
...
//
//		_cmdList->DrawIndexedInstanced(fbxData.getIndexNum(), 1, 0, 0, 0);
//
