#include "InputWavData.h"
#include <dsound.h>
#include <stdio.h>
namespace lib {
	bool InputWavData::mWavProp() {
	...
	int InputWavData::loadFile(const char* file_name) {
	...
	InputWavData::WavData
		InputWavData::getWavData() { return mWaveData; }
}