...
#include "../../../../../DirectXLib/Source/Graphics/Graph3D/ClothSimulator/ClothSimulatorOld.h"
#include "./VirtualPoint/VirtualPoint.h"
#include "./PropFile/PropFile.h"
namespace model {
	FbxModel::FbxModel()
	{
	}
	...
	bool FbxModel::mCreateVertexBuffer(ComPtr<ID3D12Device> device) {
		const UINT vertexBufferSize = static_cast<UINT>(m_Model.vertex.size()) * sizeof(lib::Vertex);
		...
		vertex_buffer_view.StrideInBytes = sizeof(lib::Vertex);
