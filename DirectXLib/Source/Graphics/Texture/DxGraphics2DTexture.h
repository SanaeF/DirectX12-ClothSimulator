...
private:
	...
	std::shared_ptr<lib::DirectX12Manager> mDxWrap;
...
public:
	...
	void CreateResource(std::shared_ptr<lib::DirectX12Manager>& DxWrap);

	void mDescriptorHeap(std::shared_ptr<lib::DirectX12Manager>& DxWrap, D3D12_DESCRIPTOR_HEAP_DESC DexcriptorHeap);
