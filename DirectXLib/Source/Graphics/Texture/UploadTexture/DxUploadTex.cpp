...
namespace libGraph {
	...
	void DxUploadTex2D::mCreateUploadResource(std::shared_ptr<lib::DirectX12Manager>& DxWrap) {
	...
	void DxUploadTex2D::CreateTexBuffer(std::shared_ptr<lib::DirectX12Manager>& DxWrap) {
	...
	void DxUploadTex2D::TextureCopy(std::shared_ptr<lib::DirectX12Manager>& DxWrap) {
		helper::LibHelper Helper;
	...
	void DxUploadTex2D::BarrierDescProp(std::shared_ptr<lib::DirectX12Manager>& DxWrap) {
	...
	void DxUploadTex2D::ShaderResourceViewforUpload(std::shared_ptr<lib::DirectX12Manager>& DxWrap) {
