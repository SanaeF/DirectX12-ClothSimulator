...
namespace libGraph {
	...
	public:
		...
		void CreateTexBuffer(std::shared_ptr<lib::DirectX12Manager>& DxWrap);

		void ResourceUpload();

		void TextureCopy(std::shared_ptr<lib::DirectX12Manager>& DxWrap);

		void BarrierDescProp(std::shared_ptr<lib::DirectX12Manager>& DxWrap);

		void ShaderResourceViewforUpload(std::shared_ptr<lib::DirectX12Manager>& DxWrap);
	...
	private:
		...
		void mCreateUploadResource(std::shared_ptr<lib::DirectX12Manager>& DxWrap);
