...
namespace phy {
	...
	private:
		Paramater m_Param;
		std::vector<lib::ModelVertex> m_Pre_vertex;
	...
	public:
		SpringForceCalculator(std::vector<lib::ModelVertex>& pre_vert);
		void gravity(int frame, std::vector<lib::ModelVertex>& vertex, std::vector<std::vector<int>>& pre_index_id);
		void restriction(int frame, std::vector<lib::ModelVertex>& vertex, std::vector<std::vector<int>>& pre_index_id);
		void createNewPosition(std::vector<lib::ModelVertex>& vertex, std::vector<SpringData>& spring_data);
		void collision(std::vector<lib::ModelVertex>& vertex);
