...
struct CD3DX12_DESCRIPTOR_RANGE : public D3D12_DESCRIPTOR_RANGE
{
    ...
    {
        Initialize(rangeType, numDescriptors, baseShaderRegister, registerSpace, offsetInDescriptorsFromTableStart);
    }
    ...
    inline void Initialize(
        ...
        D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND) noexcept
    {
        Initialize(*this, rangeType, numDescriptors, baseShaderRegister, registerSpace, offsetInDescriptorsFromTableStart);
    }
...
struct CD3DX12_ROOT_DESCRIPTOR_TABLE : public D3D12_ROOT_DESCRIPTOR_TABLE
{
    ...
    {
        Initialize(numDescriptorRanges, _pDescriptorRanges);
    }
    ...
    inline void Initialize(
        ...
        _In_reads_opt_(numDescriptorRanges) const D3D12_DESCRIPTOR_RANGE* _pDescriptorRanges) noexcept
    {
        Initialize(*this, numDescriptorRanges, _pDescriptorRanges);
    }
...
struct CD3DX12_ROOT_CONSTANTS : public D3D12_ROOT_CONSTANTS
{
    ...
    {
        Initialize(num32BitValues, shaderRegister, registerSpace);
    }
    ...
    inline void Initialize(
        ...
        UINT registerSpace = 0) noexcept
    {
        Initialize(*this, num32BitValues, shaderRegister, registerSpace);
    }
...
struct CD3DX12_ROOT_DESCRIPTOR : public D3D12_ROOT_DESCRIPTOR
{
    ...
    CD3DX12_ROOT_DESCRIPTOR(
        ...
        UINT registerSpace = 0) noexcept
    {
        Initialize(shaderRegister, registerSpace);
    }
    ...
    inline void Initialize(
        ...
        UINT registerSpace = 0) noexcept
    {
        Initialize(*this, shaderRegister, registerSpace);
    }

    static inline void Initialize(_Out_ D3D12_ROOT_DESCRIPTOR &table, UINT shaderRegister, UINT registerSpace = 0) noexcept
    {
...
struct CD3DX12_ROOT_PARAMETER : public D3D12_ROOT_PARAMETER
{
        ...
        D3D12_SHADER_VISIBILITY visibility = D3D12_SHADER_VISIBILITY_ALL) noexcept
    {
        ...
        CD3DX12_ROOT_DESCRIPTOR_TABLE::Initialize(rootParam.DescriptorTable, numDescriptorRanges, pDescriptorRanges);
    }
        ...
        D3D12_SHADER_VISIBILITY visibility = D3D12_SHADER_VISIBILITY_ALL) noexcept
    {
        ...
        rootParam.ShaderVisibility = visibility;
        CD3DX12_ROOT_CONSTANTS::Initialize(rootParam.Constants, num32BitValues, shaderRegister, registerSpace);
    }
        ...
        D3D12_SHADER_VISIBILITY visibility = D3D12_SHADER_VISIBILITY_ALL) noexcept
    {
        ...
        rootParam.ShaderVisibility = visibility;
        CD3DX12_ROOT_DESCRIPTOR::Initialize(rootParam.Descriptor, shaderRegister, registerSpace);
    }
...
struct CD3DX12_ROOT_SIGNATURE_DESC : public D3D12_ROOT_SIGNATURE_DESC
{
    ...
    {
        Initialize(0, nullptr, 0, nullptr, D3D12_ROOT_SIGNATURE_FLAG_NONE);
    }
...
struct CD3DX12_DESCRIPTOR_RANGE1 : public D3D12_DESCRIPTOR_RANGE1
{
    ...
    CD3DX12_DESCRIPTOR_RANGE1(
        ...
        D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND) noexcept
    {
        Initialize(rangeType, numDescriptors, baseShaderRegister, registerSpace, flags, offsetInDescriptorsFromTableStart);
    }
    ...
    inline void Initialize(
        ...
        D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND) noexcept
    {
        Initialize(*this, rangeType, numDescriptors, baseShaderRegister, registerSpace, flags, offsetInDescriptorsFromTableStart);
    }
...
struct CD3DX12_ROOT_DESCRIPTOR1 : public D3D12_ROOT_DESCRIPTOR1
{
    ...
    {
        Initialize(shaderRegister, registerSpace, flags);
    }
    ...
    inline void Initialize(
        ...
        D3D12_ROOT_DESCRIPTOR_FLAGS flags = D3D12_ROOT_DESCRIPTOR_FLAG_NONE) noexcept
    {
        Initialize(*this, shaderRegister, registerSpace, flags);
    }
...
struct CD3DX12_ROOT_PARAMETER1 : public D3D12_ROOT_PARAMETER1
{
        ...
        D3D12_SHADER_VISIBILITY visibility = D3D12_SHADER_VISIBILITY_ALL) noexcept
    {
        rootParam.ParameterType = D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE;
        rootParam.ShaderVisibility = visibility;
        CD3DX12_ROOT_DESCRIPTOR_TABLE1::Initialize(rootParam.DescriptorTable, numDescriptorRanges, pDescriptorRanges);
    }
        ...
        D3D12_SHADER_VISIBILITY visibility = D3D12_SHADER_VISIBILITY_ALL) noexcept
    {
        rootParam.ParameterType = D3D12_ROOT_PARAMETER_TYPE_CBV;
        rootParam.ShaderVisibility = visibility;
        CD3DX12_ROOT_DESCRIPTOR1::Initialize(rootParam.Descriptor, shaderRegister, registerSpace, flags);
    }
...
public:
    ...
    {
        Initialize(D3D12_STATE_OBJECT_TYPE_COLLECTION);
    }
...
private:
    ...
    void Initialize(D3D12_STATE_OBJECT_TYPE Type) noexcept
    {
    ...
    {
    public:
        SUBOBJECT_HELPER_BASE() noexcept { Initialize(); }
    ...
    protected:
        ...
        void Initialize() noexcept { m_pSubobject = nullptr; }
...
private:
    ...
    {
        SUBOBJECT_HELPER_BASE::Initialize();
        m_Desc = {};
        m_Strings.clear();
        m_Exports.clear();
    }
